...
define( ["require", "fs", "crypto", "uglify-js", "traverse"]
      , function(require, fs, crypto, uglify, traverse) {
        ...
        if(req.url === opts.output) {
          ...
          traverse(ast).forEach(function(node) {
            ...
            if(!  this.isRoot 
               ...
               && this.parent.node[1][this.parent.node[1].length - 1] === "server") { //and the name of the function being called is server
