...
InstanceLayer.prototype.handleEmbeddedCreateMessage = function(parentCollection, collection, parentId, document, callback) {
  this.internalSocket.emit("LiveDocumentEmbeddedCreate", parentCollection, collection, parentId, document, callback)
}
