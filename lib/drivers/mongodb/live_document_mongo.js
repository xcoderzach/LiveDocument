...
LiveDocumentMongo.prototype.handleEmbeddedCreateMessage = function(parentCollection, collection, parentId, document, callback) {
  this.db.createEmbedded(parentCollection, collection, parentId, document, callback)
}
