...
function LiveDocumentMongo(socket, connection, modelDirectory) {
...
LiveDocumentMongo.prototype.handleDocumentChange = function(id, document, type, collection) {
...
LiveDocumentMongo.prototype.notifyById = function(id, newDoc, type, collection) {
...
LiveDocumentMongo.prototype.handleReadOneMessage = function(collection, conditions, callback) {
  var that = this
