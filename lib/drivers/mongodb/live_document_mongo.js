...
LiveDocumentMongo.prototype.setSocket = function(socket) {
  ...
  this.socket.on("LiveDocumentEmbeddedDelete", this.handleEmbeddedDeleteMessage.bind(this))
}
...
LiveDocumentMongo.prototype.handleEmbeddedChange = function(parentCollection, parentId, collection, document, type) {
  this.socket.emit("EmbeddedLiveDocument" + _.capitalize(type), parentCollection, parentId, collection, document)
}
...
LiveDocumentMongo.prototype.watchEmbeddedParentId = function(id) {
  ...
  this.embeddedIds[id] = {
    unwatch: function() { 
      LiveDocumentMongo.removeListener("EmbeddedDocumentChange" + id, handler)
    }
  }
  LiveDocumentMongo.on("EmbeddedDocumentChange" + id, handler)
} 
...
LiveDocumentMongo.prototype.embeddedNotifyById = function(parentCollection, parentId, collection, newDoc, type) {
  LiveDocumentMongo.emit("EmbeddedDocumentChange" + parentId, parentCollection, parentId, collection, newDoc, type)
}
...
LiveDocumentMongo.prototype.handleEmbeddedCreateMessage = function(parentCollection, parentId, collection, document, callback) {
  ...
  this.embeddedNotifyById(parentCollection, parentId, collection, document, "create")
}
