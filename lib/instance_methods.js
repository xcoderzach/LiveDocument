...
, getDb: function() {
    if(this.constructor.isServer) {
      if(this.embedded) {
        return this.constructor.db.embedded(this.get("parentType"), this.get("parentId"), this.collectionName)
      } else {
        return this.constructor.db.collection(this.collectionName)
      }
    } else {
      if(this.embedded) {
