...
var InstanceMethods = {
  ...
  constructor: function(document, opts) {
    ...
    this.set(document, { validate: opts.validate })
...
, doAfterHooks: function(type) {
    ...
    if(!this.constructor.isServer) {
      callbacks = callbacks.concat(this.constructor.afterSaveFunctions || [])
      if(type === "create") {
        callbacks = callbacks.concat(this.constructor.afterCreateFunctionss || [])
      } else if(type === "update") {
        callbacks = callbacks.concat(this.constructor.afterUpdateFunctionss || [])
      }
    } else {
      callbacks = callbacks.concat(this.constructor.serverAfterSaveFunctions || [])
      if(type === "create") {
        callbacks = callbacks.concat(this.constructor.serverAfterCreateFunctions || [])
      } else if(type === "update") {
        callbacks = callbacks.concat(this.constructor.serverAfterUpdateFunctions || [])
      }
    }
