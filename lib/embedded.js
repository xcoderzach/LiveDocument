var LiveDocument = require("./live_document")
...
module.exports = EmbeddedLiveDocument
...
EmbeddedLiveDocument.embedded = true
...
EmbeddedLiveDocument.prototype.sendUpdate = function(id, document, callback) {
  id = id._id
