...
define(["underscore", "./live_document"], function(_, LiveDocument) {
  ...
  EmbeddedLiveDocument.prototype.sendCreate = function(document, callback) {
    this.parentDocument.constructor.socket.emit("LiveDocumentEmbeddedCreate", this.parentDocument.collectionName, this.parentDocument.get("_id"), this.collectionName, document, function(doc) {
      callback(doc)
    })
  }
  ...
  EmbeddedLiveDocument.prototype.remove = function(callback) {
    var that = this
    this.parentDocument.constructor.socket.emit("LiveDocumentEmbeddedDelete", this.parentDocument.collectionName, this.parentDocument.get("_id"), this.collectionName, {_id: this.get("_id")}, function(doc) {
      that.deleted = true
