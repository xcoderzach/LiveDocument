...
define( ["underscore", "./live_document_collection"]
  ...
  LiveDocumentClassMethods.listenForChanges = function(id, instance) {
    ...
    setTimeout(function() {
      that.garbageCollectListeners()
    }, 1000)
  }

  LiveDocumentClassMethods.garbageCollectListeners = function() {
    _(this.listeners).each(function(instances, id) {
      _(instances).each(function(instance, i) {
        console.log(i)
      })
    })
  }
