...
ClassMethods.many = function(associatedModel, name) {
  this.hasMany = this.hasMany || {}
  console.log(associatedModel.collectionName())
  this.hasMany[name || associatedModel.collectionName()] = associatedModel
  return this
}
